        ...
        <div class="modal-content bg-custom">
            ...
            <div class="modal-body">
              ...
              <?php echo  '<form method="post" action="servicepage.php?serv='.$_GET['serv'].'">';?>
                <?php
                echo '<label class="text-light">Valor R$: </label><br><input type="number" class="input-login" name="valor" class="valor-mask" id="orca-input"  min="10" max="5000" step="any" required placeholder="Insira o valor" /><br><br>';
                echo '<label class="text-light">Descrição do Serviço a prestar:</label><br> <input type="text" name="desc" class="input-login-up max"500" required placeholder="Insira a descrição"><br><br>';
                echo '<center><input type="submit" class="card-link btn btn-outline-success text-center" value="Adicionar Orçamento"></center>';
        ...
        <?php echo '<div class="modal-body" id="'.$_SESSION['cd'].'">'; ?>
          <form>
            <?php
                ...
                echo '<button data-dismiss="modal" style="text-transform: capitalize;" type="button" class="btn btn-outline-warning btn-lg" name="cancelar">Cancelar</button>';
                echo '<a href="delet.php?serv='.$_GET['serv'].'"><button style="text-transform: capitalize;" type="button" class="btn btn-outline-danger btn-lg" name="excluir">Excluir</button></a>'; 
