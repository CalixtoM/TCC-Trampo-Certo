		...
		<section class="parallax-editperfil">
			...
			<?php } ?>
					...
					<div class="col-sm-12 text-center flip-in-ver-left">
						...
						<input type="text" class="input-registro" id="phone-input" name="telefone" value="<?php echo $obj->nr_celular; ?>" minlength="11" maxlength="11" placeholder="Insira seu número de celular" required><br>
